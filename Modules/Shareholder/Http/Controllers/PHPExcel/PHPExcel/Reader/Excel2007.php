...
if (!defined('PHPEXCEL_ROOT')) {
     ...
     * @ignore
     */
    define('PHPEXCEL_ROOT', dirname(__FILE__) . '/../libs/');
    ...
    //                                    echo 'Value is ', $value, PHP_EOL;
                            ...
                            if (!$this->readDataOnly) {
                                ...
                                foreach ($comments as $relName => $relPath) {
                                    // Load comments file
                                    $relPath = PHPExcel_Shared_File::realpath(dirname("$dir/$fileWorksheet") . "Excel2007.php/" . $relPath);
                                        ...
                                        if ($xmlDrawing->oneCellAnchor) {
                                            foreach ($xmlDrawing->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing->setCoordinates(Excel2007 . phpPHPExcel_Cell::stringFromColumnIndex((string)$oneCellAnchor->from->col));
                                                    ...
                                                    $coordinates    = Excel2007 . phpPHPExcel_Cell::stringFromColumnIndex((string)$oneCellAnchor->from->col);
                                        ...
                                        if ($xmlDrawing->twoCellAnchor) {
                                            foreach ($xmlDrawing->twoCellAnchor as $twoCellAnchor) {
                                                if ($twoCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing->setPath("zip://".PHPExcel_Shared_File::realpath($pFilename)."#" . $images[(string) self::getArrayItem($blip->attributes("http://schemas.openxmlformats.org/officeDocument/2006/relationships"), "embed")], false);
                                                    $objDrawing->setCoordinates(Excel2007 . phpPHPExcel_Cell::stringFromColumnIndex((string)$twoCellAnchor->from->col));
                                                    ...
                                                    $fromCoordinate = Excel2007 . phpPHPExcel_Cell::stringFromColumnIndex((string)$twoCellAnchor->from->col);
                                                    ...
                                                    $toCoordinate   = Excel2007 . phpPHPExcel_Cell::stringFromColumnIndex((string)$twoCellAnchor->to->col);
                            ...
                            if ($xmlWorkbook->definedNames) {
                                foreach ($xmlWorkbook->definedNames->definedName as $definedName) {
                                    ...
                                    if (($spos = strpos($extractedRange, '!')) !== false) {
                                        $extractedRange = Excel2007 . phpsubstr($extractedRange, 0, $spos);
                                    } else {
...
//        }
    ...
    {
        return preg_replace('~[^/]+/\.\./~', '', dirname($base) . "/Excel2007.php");
    }
