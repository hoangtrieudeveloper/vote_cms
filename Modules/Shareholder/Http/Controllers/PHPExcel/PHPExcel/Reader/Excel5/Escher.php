...
class PHPExcel_Reader_Excel5_Escher
{
    ...
    private function readClientAnchor()
    {
        ...
        $this->object->setStartCoordinates(Escher . phpPHPExcel_Cell::stringFromColumnIndex($c1));
        ...
        $this->object->setEndCoordinates(Escher . phpPHPExcel_Cell::stringFromColumnIndex($c2));
