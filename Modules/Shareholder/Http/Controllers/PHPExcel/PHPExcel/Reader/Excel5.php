...
//        echo '<br />';
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            $formulaStructure = Excel5 . phppack('v', $flen);
    ...
    private function readFormula()
    {
        ...
        if ($isPartOfSharedFormula) {
            ...
            $this->_baseCell = Excel5 . phpPHPExcel_Cell::stringFromColumnIndex($baseCol);
        }
...
//        echo '<br />';
    ...
    private function readPane()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($this->frozen) {
                // frozen panes
                $this->phpSheet->freezePane(Excel5 . phpPHPExcel_Cell::stringFromColumnIndex($px));
            } else {
    ...
    private function readDataValidation()
    {
        ...
        $formula1 = Excel5 . phppack('v', $sz1); // prepend the length
        try {
        ...
        $formula2 = Excel5 . phppack('v', $sz2); // prepend the length
        try {
