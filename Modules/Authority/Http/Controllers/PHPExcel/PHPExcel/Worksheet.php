...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    {
        return $this->cellExists(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn));
    }
    ...
    public function getStyleByColumnAndRow($pColumn = 0, $pRow = 1, $pColumn2 = null, $pRow2 = null)
    {
        if (!is_null($pColumn2) && !is_null($pRow2)) {
            $cellRange = Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn) . ':' . PHPExcel_Cell::stringFromColumnIndex($pColumn2) . $pRow2;
            return $this->getStyle($cellRange);
        }

        return $this->getStyle(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn));
    }
    ...
    public function duplicateStyle(PHPExcel_Style $pCellStyle = null, $pRange = '')
    {
        ...
        for ($col = $rangeStart[0]; $col <= $rangeEnd[0]; ++$col) {
            for ($row = $rangeStart[1]; $row <= $rangeEnd[1]; ++$row) {
                $this->getCell(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($col - 1))->setXfIndex($xfIndex);
            }
        }
    ...
    public function duplicateConditionalStyle(array $pCellStyle = null, $pRange = '')
    {
        ...
        for ($col = $rangeStart[0]; $col <= $rangeEnd[0]; ++$col) {
            for ($row = $rangeStart[1]; $row <= $rangeEnd[1]; ++$row) {
                $this->setConditionalStyles(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($col - 1), $pCellStyle);
            }
        }
    ...
    {
        return $this->setBreak(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn), $pBreak);
    }
    ...
    {
        $cellRange = Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn1) . ':' . PHPExcel_Cell::stringFromColumnIndex($pColumn2) . $pRow2;
    ...
    public function setAutoFilterByColumnAndRow($pColumn1 = 0, $pRow1 = 1, $pColumn2 = 0, $pRow2 = 1)
    {
        return $this->setAutoFilter(
            Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn1)
            . ':' .
    ...
    {
        return $this->freezePane(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn));
    }
    ...
    */
    ...
    {
        return $this->getComment(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn));
    }
    ...
    {
        return $this->setSelectedCells(Worksheet . phpPHPExcel_Cell::stringFromColumnIndex($pColumn));
    }
