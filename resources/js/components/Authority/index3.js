                                    ...
                                    <Box className="tab-pane active" id="overview-tab" role="tabpanel">
                                        <Box className="row">
                                            ...
                                            <div className="col-xl-3 col-lg-4 col-sm-6" style={{marginBottom:10}}>
                                                ...
                                                ><i
                                                    className={"fas fa-plus"} style={{marginTop:"0px !important"}}></i> Tạo mới
                                                </Link>
                                                            ...
                                                            <span className="icon-off"><i
                                                                className="ri-check-fill align-bottom me-1">
                                                                            ...
                                                                            <button type="button"
                                                                                    ...
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#firstmodal">QR
                                                                                code
                                                                            </button>
                                                                            <Box className="modal fade" id="firstmodal"
                                                                                 aria-hidden="true"
                                                                                 tabIndex="-1">
                                                                                <Box
